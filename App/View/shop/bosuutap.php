...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* Banner trên - Paddle Smash Up */
    #banner1 {
      background: linear-gradient(to bottom, #d94444, #b83232);
    }
    #banner1 .content {
      top: 30%;
      left: 5%;
    ...
    @media (max-width: 768px) {
      #banner1 h1 { font-size: 32px; }
      #banner1 p { font-size: 16px; }
      #banner2 h1 { font-size: 60px; }
  ...
  <div class="banner" id="banner1">
    ...
    <div class="content">
      ...
      <p>Đón mùa lễ hội cùng những items không thể thiếu trong mọi tủ đồ, sẵn sàng chill đông với chất liệu ấm áp,
         mềm mại, mang lại cảm giác dễ chịu như đang thư giãn và làm điều mình yêu thích tại nhà.
          Các sản phẩm sở hữu chất vải mềm mịn, vừa giữ ấm tốt vừa thoáng khí, phù hợp cho mọi điều kiện thời tiết.
